function [proImageOut] = imageProcessDec(ImgInp,key,a)
...
for ind1 = 1 : len
    for ind2 = 1 : bre
           proImage(ind1,ind2) = uint8(mod(double(Img(ind1,ind2))*mod(Fkeynew(ind1,ind2),257),257));
    end
end
